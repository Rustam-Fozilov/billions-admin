            ...
            <div class="row g-4">
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="card">
                        <div class="card-body text-center">
                            ...
                            <div class="mb-4">
                                <h5 class="mb-1">Rosemary Krout</h5>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="card">
                        <div class="card-body text-center">
                            ...
                            <div class="mb-4">
                                <h5 class="mb-1">Miller Edwins</h5>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="card">
                        <div class="card-body text-center">
                            <div class="avatar avatar-xl mb-3">
                                <img
                                        src="../images/user/women_avatar2.jpg"
                                        class="rounded-circle" alt="...">
                            </div>
                            <div class="mb-4">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="card">
                        <div class="card-body text-center">
                            <div class="avatar avatar-xl mb-3">
                                <img src="../images/user/women_avatar5.jpg" class="rounded-circle" alt="...">
                            </div>
                            <div class="mb-4">
                                <h6>Burgess Attwool</h6>
                                <div class="text-muted">Contact</div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="card">
                        <div class="card-body text-center">
                            <div class="avatar avatar-xl mb-3">
                                <img src="../images/user/man_avatar1.jpg" class="rounded-circle" alt="...">
                            </div>
                            <div class="mb-4">
                                <h6>Allx Life</h6>
                                <div class="text-muted">Agent</div>
